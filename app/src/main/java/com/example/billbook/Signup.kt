...
class Signup : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            ...
            if (name.isNotEmpty() && email.isNotEmpty() && phone.isNotEmpty() && address.isNotEmpty() && pass.isNotEmpty() && confirmPass.isNotEmpty()) {
                if (pass == confirmPass) {
                    createUser(email, pass, name, phone, address)
                } else {
    ...
    private fun createUser(email: String, pass: String, name: String, phone: String, address: String) {
        firebaseAuth.createUserWithEmailAndPassword(email, pass)
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    if (userId != null) {
                        uploadImageAndSaveUser(userId, email, name, phone, address)
                    } else {
                        progressDialog.dismiss()
    ...
    private fun uploadImageAndSaveUser(userId: String, email: String, name: String, phone: String, address: String) {
        imageUri?.let { uri ->
            ...
            storageReference.putFile(uri)
                .addOnSuccessListener {
                    storageReference.downloadUrl.addOnSuccessListener { downloadUri ->
                        ...
                        saveUserToFirestore(userId, email, name, phone, address, imageUrl)
    ...
    private fun saveUserToFirestore(userId: String, email: String, name: String, phone: String, address: String, imageUrl: String) {
        val user = hashMapOf(
            "name" to name,
            "email" to email,
            "phone" to phone,
